# Sonnerie longue (alerte generale, evenement, fin de journee). Portee maximale.
...
execute as @e[type=armor_stand,tag=academie_cloche_main,limit=1] run tellraw @a[distance=..120] ["",{"text":"🔔🔔 ","color":"gold"},{"text":"La grande cloche retentit dans toute l'ecole !","color":"yellow","bold":true}]
